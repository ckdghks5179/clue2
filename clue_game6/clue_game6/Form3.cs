    ...
    public partial class Form3 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (choose == 1)
            {
                ...
                var openMatch = gameState.openCard.Where(c => guessedNames.Contains(c.name)).ToList();
            ...
            else if (choose == 2)
            {
                    ...
                    gameState.answer[2].name == roomBox.Text)
                {
                    ...
                    MessageBox.Show("정답입니다! 승리했습니다!");
                    //Application.Exit(); 승리 할 때 이벤트 추가 필요
                }
                else
                {
        ...
        {
            if (manBox.SelectedIndex != -1 &&
                roomBox.SelectedIndex != -1 &&
                weaponBox.SelectedIndex != -1)
            {
